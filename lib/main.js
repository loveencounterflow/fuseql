(function() {
  var CND, ERROR, FUSE, OK, SQLITE3, alert, badge, db, db_route, debug, echo, fallback_gid, fallback_mode, fallback_size, fallback_time, fallback_uid, help, info, log, mount_locator, mount_route, njs_path, rpr, sqlitefs, urge, warn, whisper;
      ...
      switch (route) {
        ...
        default:
          ...
          db.get(sql, home, name, function(error, record) {
            ...
            return handler(OK, file_description);
          });
      }
      return null;
    },
